                                ...
                                <form action="supplier-edit-act.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if (!empty($row['foto'])): ?>
                                            <div class="mb-2">
                                                <?php $imgPath = (strpos($row['foto'], 'http') === 0) ? $row['foto'] : '../' . ltrim($row['foto'], '/'); ?>
                                                <img src="<?=$imgPath;?>" alt="Foto" style="width:60px;height:60px;object-fit:cover;border-radius:50%;border:2px solid #38b6ff;background:#e0f2fe;">
                                            </div>
                                        <?php endif; ?>
