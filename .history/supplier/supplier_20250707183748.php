                                ...
                                <div class="table-responsive rounded-4 overflow-hidden">
                                    <table class="table table-hover align-middle mb-0" style="background:#fff;">
                                        ...
                                        while ($row = $result->fetch_object()) {
                                            ...
                                            echo "<button type='button' class='btn btn-info btn-sm px-3 py-1 fw-bold d-inline-flex align-items-center' style='border-radius:1.5rem;background:#e0f2fe;border:1.5px solid #38b6ff;color:#0369a1;gap:4px;' data-bs-toggle='modal' data-bs-target='#modalDetail' data-id='" . $row->id_supplier . "'><i class='bi bi-eye'></i><span></span></button>";
                                            echo "<a href='./supplier-edit.php?id=" . $row->id_supplier . "' class='btn btn-outline-primary btn-sm px-3 py-1 fw-bold d-inline-flex align-items-center' style='border-radius:1.5rem;background:#f0f9ff;border:1.5px solid #38b6ff;color:#0369a1;gap:4px;'><i class='bi bi-pencil-square'></i><span></span></a>";
                                            echo "<a href='./supplier-hapus.php?id=" . $row->id_supplier . "' class='btn btn-outline-danger btn-sm px-3 py-1 fw-bold d-inline-flex align-items-center' style='border-radius:1.5rem;background:#f0f9ff;border:1.5px solid #e11d48;color:#e11d48;gap:4px;' onclick=\"return confirm('Yakin ingin menghapus data ini?')\"><i class='bi bi-trash'></i><span></span></a>";
                                            echo "</div>";
