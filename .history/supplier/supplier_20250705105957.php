                                    ...
                                    <table class="table table-hover align-middle mb-0" style="background:#fff;">
                                        ...
                                        while ($row = $result->fetch_object()) {
                                            ...
                                            if (!empty($row->foto)) {
                                                ...
                                                echo "<img src='" . htmlspecialchars($imgPath) . "' alt='Foto' style='width:40px;height:40px;object-fit:cover;border-radius:50%;border:1.5px solid #38b6ff;background:#e0f2fe;'> ";
                                            } else {
