                            ...
                            <div class="card-body py-4 px-4">
                                <form action="matrik-simpan.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="id_criteria" class="form-control form-control-lg rounded-3" required>
                                            <?php
                                            $sql_criterias = "SELECT * FROM saw_criterias ORDER BY id_criteria";
                                            $result_criterias = $db->query($sql_criterias);
                                            while($criteria = $result_criterias->fetch_object()) {
                                                echo "<option value=\"" . $criteria->id_criteria . "\">" . htmlspecialchars($criteria->criteria_name) . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
