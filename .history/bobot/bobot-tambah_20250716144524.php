    ...
    <div id="app">
        ...
        <div id="" style="padding:0;min-height:100vh;background:#f4faff;" class="m-5 p-5 rounded rounded-4 shadow-sm">
            ...
            <div class="page-heading mb-4">
                <h3 class="fw-bold mb-2" style="color:#0369a1;letter-spacing:1px;">Tambah Kriteria</h3>
            </div>
                    ...
                    <div class="col-12 col-md-8 col-lg-7">
                        <div class="card border-0 rounded-4 shadow-sm" style="background:#f8fbff;">
                            <div class="card-header bg-white border-0 rounded-top-4" style="border-bottom:1px solid #e0e7ef; background:#e0f2fe;">
                                <h4 class="card-title fw-bold mb-0" style="color:#0369a1;letter-spacing:0.5px;">Form Tambah Kriteria</h4>
                            </div>
                            <div class="card-body py-4 px-4">
                                <form action="bobot-simpan.php" method="POST">
                                    <div class="mb-3">
                                        <label for="criteria" class="form-label fw-semibold text-dark">Nama Kriteria</label>
                                        <input type="text" class="form-control form-control-lg rounded-3" id="criteria" name="criteria" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="weight" class="form-label fw-semibold text-dark">Bobot</label>
                                        <input type="number" step="0.01" min="0" max="1" class="form-control form-control-lg rounded-3" id="weight" name="weight" required>
                                        <small class="text-muted">Nilai bobot antara 0-1 (contoh: 0.25)</small>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a href="bobot.php" class="btn btn-secondary btn-lg px-4 fw-bold" style="border-radius:1.5rem;background:#94a3b8;border:none;">
