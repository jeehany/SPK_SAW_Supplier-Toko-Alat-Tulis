                ...
                <div class="col-lg-6 d-none d-lg-block" style="background:linear-gradient(135deg,#38b6ff 0%,#e0f2fe 100%);">
                    <div class="h-100 d-flex align-items-center justify-content-center">
                        <div class="text-center p-5">
                            ...
                            <div class="mt-4">
                                <div class="fw-bold" style="font-size:1.35rem;letter-spacing:0.5px;line-height:1.3;color:#fff;text-shadow:0 2px 8px rgba(0,0,0,0.18),0 1px 0 #38b6ff;">
                                    Selamat datang
                                </div>
                                <div class="mt-2" style="font-size:1.08rem;line-height:1.5;color:#f0f9ff;text-shadow:0 1px 4px rgba(0,0,0,0.13);">
                                    di <span class="fw-semibold" style="color:#fff;">Sistem Pendukung Keputusan</span>
                                </div>
                                <div class="mt-3 d-flex flex-column align-items-center gap-2">
                                    <span class="badge px-3 py-2" style="font-size:1.05rem;background:#38b6ff;color:#fff;box-shadow:0 2px 8px rgba(0,0,0,0.10);letter-spacing:0.5px;">Metode SAW</span>
                                    <span class="fw-semibold" style="color:#fff;">Pemilihan Supplier Alat Tulis</span>
                                </div>
                            </div>
                        </div>
                    </div>
