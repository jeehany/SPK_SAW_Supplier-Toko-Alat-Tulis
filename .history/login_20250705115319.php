                        ...
                        <div class="text-center p-5">
                            ...
                            <div class="mt-4">
                                <div class="fw-bold" style="font-size:1.35rem;letter-spacing:0.5px;line-height:1.3;color:#fff;text-shadow:0 2px 8px rgba(0,0,0,0.18),0 1px 0 #38b6ff;">
                                    Selamat datang<br>
                                    <span class="d-block" style="font-size:1.1rem;font-weight:400;margin-top:0.5rem;">di Sistem Pendukung Keputusan</span>
                                </div>
                                <div class="mt-3" style="font-size:1.08rem;line-height:1.5;color:#f0f9ff;text-shadow:0 1px 4px rgba(0,0,0,0.13);">
                                    <span >Metode SAW</span><br>
                                    <span class="badge mb-2" style="font-size:1rem;background:#38b6ff;color:#fff;box-shadow:0 2px 8px rgba(0,0,0,0.10);" style="color:#fff;">Pemilihan Supplier Alat Tulis</span>
                                </div>
                            </div>
                        </div>
                    </div>
