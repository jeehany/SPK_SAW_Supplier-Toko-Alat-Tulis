                ...
                <div class="col-lg-6 d-none d-lg-block" style="background:linear-gradient(135deg,#38b6ff 0%,#e0f2fe 100%);">
                    <div class="h-100 d-flex align-items-center justify-content-center">
                        <div class="text-center p-5">
                            <img src="assets/images/login-illustration.png" alt="Login Illustration" style="max-width:320px;width:100%;">
                            <div class="mt-4 text-white fw-bold" style="font-size:1.15rem;letter-spacing:0.5px;">Selamat datang di Sistem Pendukung Keputusan<br>Metode SAW - Pemilihan Supplier Alat Tulis</div>
                        </div>
                    </div>
                </div>
            </div>
