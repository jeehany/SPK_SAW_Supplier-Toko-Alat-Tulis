                ...
                <div class="col-lg-6 d-none d-lg-block" style="background:linear-gradient(135deg,#38b6ff 0%,#e0f2fe 100%);">
                    <div class="h-100 d-flex align-items-center justify-content-center">
                        <div class="text-center p-5">
                            ...
                            <div class="mt-4">
                                <div class="fw-bold text-white" style="font-size:1.35rem;letter-spacing:0.5px;line-height:1.3;">
                                    Selamat datang<br>
                                    <span class="d-block" style="font-size:1.1rem;font-weight:400;margin-top:0.5rem;">di Sistem Pendukung Keputusan</span>
                                </div>
                                <div class="mt-3 text-white-50" style="font-size:1.08rem;line-height:1.5;">
                                    <span class="badge bg-primary mb-2" style="font-size:1rem;background:#38b6ff;">Metode SAW</span><br>
                                    <span>Pemilihan Supplier Alat Tulis</span>
                                </div>
                            </div>
                        </div>
                    </div>
